	...
	<div class="crp-right-container" style="float: <?php echo is_rtl() ? 'left;' : 'right;'; ?>">
		...
		<div class="wt_rp_exclusive_gopro">
			<div class="wt_rp_exclusive_gopro_content">
				...
				<p class="wt_rp_exclusive_gopro_txt"><?php esc_html_e( 'Our free plugins are getting all of the premium promotion plugins at <b>30% off<b>.', 'wt-woocommerce-related-products' ); ?></p class=""> 
